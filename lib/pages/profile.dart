...
class Settings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var urL =
        "https://www.nicepng.com/png/full/192-1923042_github-icon-png-github-png.png";
    return Scaffold(
      appBar: AppBar(
        ...
        children: [
          const Padding(
            ...
            child: Text(
              'Profile',
              style: TextStyle(
                  fontFamily: 'ankit', fontSize: 40, color: Colors.black),
            ),
          ),
          Row(
            children: [
          ...
          Container(
            ...
            child: const Center(
                child: Text(
              ' UserName  : NUll',
              style: TextStyle(fontFamily: 'ankit', fontSize: 25),
            )),
          ),
          const Divider(
            thickness: 4,
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: const Padding(
                ...
                child: Text(
                    style: TextStyle(fontSize: 20, fontFamily: 'ankit'),
